...
#
#  적용 범위: applicationsets/** · addons/** · projects/** · clusters/** · bootstrap/** 의 *.yaml, *.sh,
...
#
#  ⚠️ 이 저장소에 .yaml 을 새로 만들 때는 root App 의 include(bootstrap/root-app.yaml)를 함께
#     본다. applicationsets/ 아래 .yaml 은 전부 매니페스트로 읽히고, addons/ 는 읽히지 않는다.
#
